...
export function SidePanel() {
    ...
    const menuGroups = {
        ...
        // --- Nuevo grupo de menú para Tickets ---
        tickets: {
            title: "Tickets",
            icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 5v2m0 4v2m0 4v2M9 9h1a2 2 0 002-2V3a1 1 0 00-1-1H5a1 1 0 00-1 1v2c0 .552.448 1 1 1h1zm0 3H9v2h2v-2zm0 4H9v2h2v-2zm0 4H9v2h2v-2z" />
                </svg>
            ),
            items: [
